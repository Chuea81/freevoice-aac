...
interface ItemDef {
  ...
  imageUrl?: string;  // local symbol image (e.g. /symbols/custom/food.png)
}
...
const BOARD_DEFS: BoardDef[] = [
  // ═══ HOME (root board — copied from prototype) ═══
  {
    ...
    items: [
      { emoji: '🍎', label: 'Food',
        imageUrl: '/symbols/custom/food.webp',
         category: 'food' },
      { emoji: '😊', label: 'Feelings',
        imageUrl: '/symbols/custom/feelings.webp',
         category: 'feelings' },
      { emoji: '⚽', label: 'Play',
        imageUrl: '/symbols/custom/play.webp',
         category: 'activities' },
      { emoji: '💬', label: 'Social',
        imageUrl: '/symbols/custom/social.webp',
         category: 'social' },
      { emoji: '🛁', label: 'Body',
        imageUrl: '/symbols/custom/body.webp',
         category: 'body' },
      { emoji: '🏫', label: 'School',
        imageUrl: '/symbols/custom/school.webp',
         category: 'school' },
      { emoji: '🌙', label: 'Bedtime',
        imageUrl: '/symbols/custom/bedtime.webp',
         category: 'bedtime' },
      { emoji: '🐾', label: 'Animals',
        imageUrl: '/symbols/custom/animals.webp',
         category: 'animals' },
      { emoji: '🌍', label: 'Places',
        imageUrl: '/symbols/custom/places.webp',
         category: 'places' },
      { emoji: '👕', label: 'Clothing',
        imageUrl: '/symbols/custom/clothing.webp',
         category: 'clothing' },
      { emoji: '📋', label: 'Routines',
        imageUrl: '/symbols/custom/routines.webp',
         category: 'routines' },
      { emoji: '🚗', label: 'Transportation',
        imageUrl: '/symbols/custom/transportation.webp',
         category: 'transportation' },
      { emoji: '📱', label: 'Technology',
        imageUrl: '/symbols/custom/technology.webp',
         category: 'technology' },
      { emoji: '🌿', label: 'Nature',
        imageUrl: '/symbols/custom/nature.webp',
         category: 'nature' },
      { emoji: '✅', label: 'Yes',
        imageUrl: '/symbols/custom/yes.webp',
         phrase: 'Yes', wordType: 'social' },
      { emoji: '❌', label: 'No',
        imageUrl: '/symbols/custom/no.webp',
         phrase: 'No', wordType: 'social' },
      { emoji: '🤲', label: 'Please',
        imageUrl: '/symbols/custom/please.webp',
         phrase: 'Please', wordType: 'social' },
      { emoji: '💛', label: 'Thank You',
        imageUrl: '/symbols/custom/thank_you.webp',
         phrase: 'Thank you', wordType: 'social' },
      { emoji: '💔', label: 'Hurts',
        imageUrl: '/symbols/custom/hurts.webp',
         phrase: 'That hurts', wordType: 'descriptor' },
      { emoji: '🆘', label: 'Help',
        imageUrl: '/symbols/custom/help.webp',
         phrase: 'I need help', wordType: 'social' },
      { emoji: '🚫', label: 'Stop',
        imageUrl: '/symbols/custom/stop.webp',
         phrase: 'Stop', wordType: 'social' },
      { emoji: '➕', label: 'More',
        imageUrl: '/symbols/custom/more.webp',
         phrase: 'More please', wordType: 'social' },
      { emoji: '🤚', label: 'Hi',
        imageUrl: '/symbols/custom/hi.webp',
         phrase: 'Hi!', wordType: 'social' },
      { emoji: '✋', label: 'Wait',
        imageUrl: '/symbols/custom/wait.webp',
         phrase: 'Wait', wordType: 'social' },
    ],
  },
  ...
  // ═══ JUICE TYPES ═══
  {
    ...
    items: [
      { emoji: '🍊', label: 'Orange Juice',
        imageUrl: '/symbols/custom/orange_juice.webp',
         phrase: 'Drink orange juice please', wordType: 'noun' },
      { emoji: '🍎', label: 'Apple Juice',
        imageUrl: '/symbols/custom/apple_juice.webp',
         phrase: 'Drink apple juice please', wordType: 'noun' },
      { emoji: '🍇', label: 'Grape Juice',
        imageUrl: '/symbols/custom/grape_juice.webp',
         phrase: 'Drink grape juice please', wordType: 'noun' },
      { emoji: '🍍', label: 'Pineapple Juice',
        imageUrl: '/symbols/custom/pineapple_juice.webp',
         phrase: 'Drink pineapple juice', wordType: 'noun' },
      { emoji: '🥭', label: 'Mango Juice',
        imageUrl: '/symbols/custom/mango_juice.webp',
         phrase: 'Drink mango juice', wordType: 'noun' },
      { emoji: '🍒', label: 'Cranberry Juice',
        imageUrl: '/symbols/custom/cranberry_juice.webp',
         phrase: 'Drink cranberry juice', wordType: 'noun' },
      { emoji: '🍓', label: 'Strawberry Juice',
        imageUrl: '/symbols/custom/strawberry_juice.webp',
         phrase: 'Drink strawberry juice', wordType: 'noun' },
    ],
  },
  ...
  // ═══ AMERICAN FOOD ═══
  {
    ...
    items: [
      { emoji: '🍔', label: 'Hamburger',
        imageUrl: '/symbols/custom/hamburger.webp',
         phrase: 'Eat hamburger', wordType: 'noun' },
      { emoji: '🌭', label: 'Hot Dog',
        imageUrl: '/symbols/custom/hot_dog.webp',
         phrase: 'Eat hot dog', wordType: 'noun' },
      { emoji: '🍕', label: 'Pizza',
        imageUrl: '/symbols/custom/pizza.webp',
         phrase: 'Eat pizza', wordType: 'noun' },
      { emoji: '🍗', label: 'Fried Chicken',
        imageUrl: '/symbols/custom/fried_chicken.webp',
         phrase: 'Eat fried chicken', wordType: 'noun' },
      { emoji: '🥪', label: 'Sandwich',
        imageUrl: '/symbols/custom/sandwich.webp',
         phrase: 'Eat sandwich', wordType: 'noun' },
      { emoji: '🧀', label: 'Grilled Cheese',
        imageUrl: '/symbols/custom/grilled_cheese.webp',
         phrase: 'Eat grilled cheese', wordType: 'noun' },
      { emoji: '🥓', label: 'Bacon',
        imageUrl: '/symbols/custom/bacon.webp',
         phrase: 'Eat bacon', wordType: 'noun' },
      { emoji: '🥞', label: 'Pancakes',
        imageUrl: '/symbols/custom/pancakes.webp',
         phrase: 'Eat pancakes', wordType: 'noun' },
      { emoji: '🧇', label: 'Waffles',
        imageUrl: '/symbols/custom/waffles.webp',
         phrase: 'Eat waffles', wordType: 'noun' },
      { emoji: '🍳', label: 'Eggs',
        imageUrl: '/symbols/custom/eggs.webp',
         phrase: 'Eat eggs', wordType: 'noun' },
      { emoji: '🥣', label: 'Cereal',
        imageUrl: '/symbols/custom/cereal.webp',
         phrase: 'Eat cereal', wordType: 'noun' },
      { emoji: '🥪', label: 'PB&J',
        imageUrl: '/symbols/custom/pbj.webp',
         phrase: 'Eat peanut butter and jelly', wordType: 'noun' },
      { emoji: '🌽', label: 'Corn on the Cob',
        imageUrl: '/symbols/custom/corn_on_the_cob.webp',
         phrase: 'Eat corn on the cob', wordType: 'noun' },
      { emoji: '🥣', label: 'Mashed Potatoes',
        imageUrl: '/symbols/custom/mashed_potatoes.webp',
         phrase: 'Eat mashed potatoes', wordType: 'noun' },
      { emoji: '🍟', label: 'French Fries',
        imageUrl: '/symbols/custom/french_fries.webp',
         phrase: 'Eat french fries', wordType: 'noun' },
      { emoji: '🥗', label: 'Salad',
        imageUrl: '/symbols/custom/salad.webp',
         phrase: 'Eat salad', wordType: 'noun' },
      { emoji: '🥩', label: 'BBQ Ribs',
        imageUrl: '/symbols/custom/bbq_ribs.webp',
         phrase: 'Eat bbq ribs', wordType: 'noun' },
      { emoji: '🥩', label: 'Steak',
        imageUrl: '/symbols/custom/steak.webp',
         phrase: 'Eat steak', wordType: 'noun' },
      { emoji: '🧀', label: 'Mac and Cheese',
        imageUrl: '/symbols/custom/mac_and_cheese.webp',
         phrase: 'Eat mac and cheese', wordType: 'noun' },
      { emoji: '🍲', label: 'Chili',
        imageUrl: '/symbols/custom/chili.webp',
         phrase: 'Eat chili', wordType: 'noun' },
      { emoji: '🥧', label: 'Pot Pie',
        imageUrl: '/symbols/custom/pot_pie.webp',
         phrase: 'Eat pot pie', wordType: 'noun' },
      { emoji: '🍲', label: 'Soup',
        imageUrl: '/symbols/custom/soup.webp',
         phrase: 'Eat soup', wordType: 'noun' },
      { emoji: '🍞', label: 'Biscuits',
        imageUrl: '/symbols/custom/biscuits.webp',
         phrase: 'Eat biscuits', wordType: 'noun' },
      { emoji: '🍳', label: 'Omelette',
        imageUrl: '/symbols/custom/omelette.webp',
         phrase: 'Eat omelette', wordType: 'noun' },
      { emoji: '🥩', label: 'Meatloaf',
        imageUrl: '/symbols/custom/meatloaf.webp',
         phrase: 'Eat meatloaf', wordType: 'noun' },
    ],
  },
