...
const BOARD_DEFS: BoardDef[] = [
  ...
  // ═══ JUICE TYPES ═══
  {
    ...
    items: [
      ...
      { emoji: '🍑', label: 'Peach Juice', phrase: 'Drink peach juice', wordType: 'noun' },
    ],
  },
  ...
  // ═══ FRUITS (new subcategory) ═══
  {
    ...
    items: [
      ...
      { emoji: '🍑', label: 'Peach', phrase: 'Eat peach', wordType: 'noun' },
  ...
  // ═══ COMMUNITY (expanded to 20 items) ═══
  {
    ...
    items: [
      { emoji: '🩺', label: 'Doctor', phrase: 'Doctor', wordType: 'noun' },
      ...
      { emoji: '💊', label: 'Nurse', phrase: 'Nurse', wordType: 'noun' },
      { emoji: '✈️', label: 'Pilot', phrase: 'Pilot', wordType: 'noun' },
      { emoji: '🏗️', label: 'Builder', phrase: 'Builder', wordType: 'noun' },
