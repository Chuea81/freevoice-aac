...
const BOARD_DEFS: BoardDef[] = [
  // ═══ HOME (root board — copied from prototype) ═══
  {
    ...
    items: [
      { emoji: '🍎', label: 'Food',
        imageUrl: '/symbols/custom/food.png',
         category: 'food' },
      { emoji: '😊', label: 'Feelings',
        imageUrl: '/symbols/custom/feelings.png',
         category: 'feelings' },
      { emoji: '⚽', label: 'Play',
        imageUrl: '/symbols/custom/play.png',
         category: 'activities' },
      { emoji: '💬', label: 'Social',
        imageUrl: '/symbols/custom/social.png',
         category: 'social' },
      { emoji: '🛁', label: 'Body',
        imageUrl: '/symbols/custom/body.png',
         category: 'body' },
      { emoji: '🏫', label: 'School',
        imageUrl: '/symbols/custom/school.png',
         category: 'school' },
      { emoji: '🌙', label: 'Bedtime',
        imageUrl: '/symbols/custom/bedtime.png',
         category: 'bedtime' },
      { emoji: '🐾', label: 'Animals',
        imageUrl: '/symbols/custom/animals.png',
         category: 'animals' },
      { emoji: '🌍', label: 'Places',
        imageUrl: '/symbols/custom/places.png',
         category: 'places' },
      { emoji: '👕', label: 'Clothing',
        imageUrl: '/symbols/custom/clothing.png',
         category: 'clothing' },
      { emoji: '📋', label: 'Routines',
        imageUrl: '/symbols/custom/routines.png',
         category: 'routines' },
      { emoji: '🚗', label: 'Transportation',
        imageUrl: '/symbols/custom/transportation.png',
         category: 'transportation' },
      { emoji: '📱', label: 'Technology',
        imageUrl: '/symbols/custom/technology.png',
         category: 'technology' },
      { emoji: '🌿', label: 'Nature',
        imageUrl: '/symbols/custom/nature.png',
         category: 'nature' },
      { emoji: '✅', label: 'Yes',
        imageUrl: '/symbols/custom/yes.png',
         phrase: 'Yes', wordType: 'social' },
      { emoji: '❌', label: 'No',
        imageUrl: '/symbols/custom/no.png',
         phrase: 'No', wordType: 'social' },
      { emoji: '🤲', label: 'Please',
        imageUrl: '/symbols/custom/please.png',
         phrase: 'Please', wordType: 'social' },
      { emoji: '💛', label: 'Thank You',
        imageUrl: '/symbols/custom/thank_you.png',
         phrase: 'Thank you', wordType: 'social' },
      { emoji: '💔', label: 'Hurts',
        imageUrl: '/symbols/custom/hurts.png',
         phrase: 'That hurts', wordType: 'descriptor' },
      { emoji: '🆘', label: 'Help',
        imageUrl: '/symbols/custom/help.png',
         phrase: 'I need help', wordType: 'social' },
      { emoji: '🚫', label: 'Stop',
        imageUrl: '/symbols/custom/stop.png',
         phrase: 'Stop', wordType: 'social' },
      { emoji: '➕', label: 'More',
        imageUrl: '/symbols/custom/more.png',
         phrase: 'More please', wordType: 'social' },
      { emoji: '🤚', label: 'Hi',
        imageUrl: '/symbols/custom/hi.png',
         phrase: 'Hi!', wordType: 'social' },
      { emoji: '✋', label: 'Wait',
        imageUrl: '/symbols/custom/wait.png',
