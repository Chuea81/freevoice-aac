...
const BOARD_DEFS: BoardDef[] = [
  ...
  // ═══ FEELINGS (copied from prototype) ═══
  {
    ...
    items: [
      { emoji: '😄', label: 'Happy', phrase: 'I am happy', wordType: 'descriptor' },
      { emoji: '😢', label: 'Sad', phrase: 'I am sad', wordType: 'descriptor' },
      { emoji: '😡', label: 'Angry', phrase: 'I am angry', wordType: 'descriptor' },
      ...
      { emoji: '🥱', label: 'Bored', phrase: 'I am bored', wordType: 'descriptor' },
      { emoji: '🤗', label: 'Love', phrase: 'I love you', wordType: 'descriptor' },
      { emoji: '😤', label: 'Frustrated', phrase: 'I am frustrated', wordType: 'descriptor' },
      { emoji: '🥰', label: 'Good', phrase: 'I feel good', wordType: 'descriptor' },
      { emoji: '😰', label: 'Worried', phrase: 'I am worried', wordType: 'descriptor' },
      { emoji: '🥳', label: 'Excited', phrase: 'I am excited', wordType: 'descriptor' },
      { emoji: '😬', label: 'Nervous', phrase: 'I am nervous', wordType: 'descriptor' },
      { emoji: '😌', label: 'Calm', phrase: 'I am calm', wordType: 'descriptor' },
      { emoji: '🤔', label: 'Confused', phrase: 'I am confused', wordType: 'descriptor' },
      { emoji: '😲', label: 'Surprised', phrase: 'I am surprised', wordType: 'descriptor' },
      // Expanded feelings (TDSnap analysis: need deeper emotional vocabulary)
      { emoji: '😇', label: 'Proud', phrase: 'I am proud', wordType: 'descriptor' },
      { emoji: '😔', label: 'Lonely', phrase: 'I feel lonely', wordType: 'descriptor' },
      { emoji: '😳', label: 'Embarrassed', phrase: 'I am embarrassed', wordType: 'descriptor' },
      { emoji: '🥺', label: 'Hurt Feelings', phrase: 'My feelings are hurt', wordType: 'descriptor' },
      { emoji: '🫣', label: 'Shy', phrase: 'I feel shy', wordType: 'descriptor' },
      { emoji: '😏', label: 'Silly', phrase: 'I feel silly', wordType: 'descriptor' },
      { emoji: '🥹', label: 'Grateful', phrase: 'I feel grateful', wordType: 'descriptor' },
      { emoji: '😞', label: 'Disappointed', phrase: 'I am disappointed', wordType: 'descriptor' },
    ],
  },
  ...
  // ═══ FOOD (copied from prototype + expanded) ═══
  {
    ...
    items: [
      ...
      { emoji: '🥪', label: 'Sandwich', phrase: 'Sandwich', wordType: 'noun' },
      { emoji: '🍕', label: 'Pizza', phrase: 'Pizza', wordType: 'noun' },
      { emoji: '🍗', label: 'Chicken', phrase: 'Chicken', wordType: 'noun' },
      { emoji: '🥕', label: 'Carrots', phrase: 'Carrots', wordType: 'noun' },
      { emoji: '🧀', label: 'Cheese', phrase: 'Cheese', wordType: 'noun' },
      ...
      { emoji: '🍞', label: 'Bread', phrase: 'Bread', wordType: 'noun' },
      { emoji: '🥚', label: 'Egg', phrase: 'Egg', wordType: 'noun' },
  ...
  // ═══ SNACKS (copied from prototype + expanded) ═══
  {
    ...
    items: [
      ...
      { emoji: '🥜', label: 'Nuts', phrase: 'Nuts', wordType: 'noun' },
  ...
  // ═══ ACTIVITIES / PLAY (copied from prototype + expanded) ═══
  {
    ...
    items: [
      ...
      { emoji: '🛁', label: 'Bath', phrase: 'Take a bath', wordType: 'noun' },
  ...
  // ═══ BODY (copied from prototype + expanded) ═══
  {
    ...
    items: [
      ...
      { emoji: '🫧', label: 'Wash Hands', phrase: 'Wash my hands', wordType: 'verb' },
      { emoji: '🪥', label: 'Brush Teeth', phrase: 'Brush teeth', wordType: 'verb' },
  ...
  // ═══ BEDTIME (copied from prototype) ═══
  {
    ...
    items: [
      { emoji: '😴', label: 'Sleepy', phrase: 'I am sleepy', wordType: 'descriptor' },
      { emoji: '🪥', label: 'Brush Teeth', phrase: 'Brush teeth', wordType: 'verb' },
      { emoji: '🛁', label: 'Bath', phrase: 'Bath time', wordType: 'noun' },
