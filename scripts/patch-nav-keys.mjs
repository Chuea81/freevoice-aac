// I18N-05: the TabBar looks up nav.<tabId>, but tab ids are
// home/feelings/food/activities/social/body/school/places/routines/custom while
// the locales only had home/feelings/food/play/myWords. So 7 of 10 tabs showed
// English even in "complete" locales. This adds the missing keys to every
// locale (activities = the existing "play" word, custom = the existing
// "myWords" word, plus translations for the rest).
//
...
// social / body / school / places / routines per language (single-word category labels)
const T = {
